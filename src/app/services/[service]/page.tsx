            ...
            <div className="w-full lg:w-1/3">
              <div className="sticky top-32 rounded-2xl overflow-hidden shadow-xl border border-slate-100 bg-white">
                ...
                <div className="p-8">
                  ...
                  <a href="tel:+33200000000" className="flex items-center justify-center w-full py-3 px-4 bg-slate-100 text-slate-700 rounded-lg font-medium hover:bg-slate-200 transition-colors">
                    Appeler une urgence
                  </a>
                </div>
              </div>
